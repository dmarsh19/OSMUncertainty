...
inTextFileName = "100kNC.txt"
outFileName = "100kNCresults" + str(beginLine) + "-" + str(endLine) + ".txt"
...
outFile.write("ODIndex\toriginLat\toriginLng\tdestinationLat\tdestinationLng\tGoogleMile\tGoogleMin\tArcGISMile\tArcGISMin\tOSMMile\tOSMMin\n")
...
while runOD in range(len(pointList)):
    ...
    output = [ODIndex, originLat, originLng, destinationLat, destinationLng, googleRoute, arcRoute, mapquestRoute]
