...
parser = argparse.ArgumentParser(epilog = "Input file type "
                                 "must be '*.txt' in the following "
                                 "format:\n----------------------------"
                                 "-------------------------------------"
                                 "-------\n<header: index\t"
                                 "OriginLong\tOriginLat"
                                 "\tDestLong\tDestLat>\n1<tab>"
                                 "-80.804455<tab>35.245815<tab>"
                                 "-80.944335<tab>35.226081\n2\t"
                                 "-80.822452\t35.078326\t"
                                 "-80.894568\t35.075842\n...\n\nPath "
                                 "defaults to script directory, but "
                                 "absolute paths can be used to \n"
                                 "override the default.",
                                 description = __doc__,
                                 formatter_class=argparse.
                                 RawDescriptionHelpFormatter)
parser.add_argument("<input_file>", help = "The filename that contains "
                    "origin and destination coordinates used to create "
                    "routes. See help epilog (below) for input "
